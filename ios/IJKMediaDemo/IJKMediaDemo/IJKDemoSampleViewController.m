...
- (void)viewDidLoad {
    ...
    [sampleList addObject:@[@"otus", @"rtsp://192.168.1.1/live1.sdp"]];
    [sampleList addObject:@[@"Wowza rtsp test", @"rtsp://wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mov"]];
